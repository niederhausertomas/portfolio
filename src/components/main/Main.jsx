...
const Main = () => {
  ...
  return (
    <main className='w-full'>
      ...
      <h2 className="p-10 w-full h-[150px] text-[50px] text-center text-[#aaa8a8] mt-[30px]" id="Skills">
        {t("skills")}
      </h2>
      <Skills/>
      ...
      <h2 className="p-10 w-full h-[150px] text-[50px] text-center text-[#aaa8a8]" id="about">
        {t("aboutMe")}
      </h2>
